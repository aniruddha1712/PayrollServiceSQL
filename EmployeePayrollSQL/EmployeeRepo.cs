...
namespace EmployeePayrollSQL
{
    ...
    {
        string connectionString = @"Data Source=CG-DTE-STUDENT\SQLEXPRESS;Initial Catalog=Payroll_Service;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
